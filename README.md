...
)](https://pkg.go.dev/github.com/token/UTG?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/token/UTG)](https://goreportcard.com/report/github.com/token/UTG)
[![Travis](https://travis-ci.com/token/UTG.svg?branch=master)](https://travis-ci.com/token/UTG)
[![Discord](https://img.shields.io/badge/discord-join%20chat-blue.svg)](https://discord.gg/nthXNEv)

Automated builds are available for stable releases and the unstable master branch. Binary
archives are published at https://github.com/UltronGlow/Mainnet-Beta.

## Building the source

Building `utg` requires both a Go (version 1.71 or later) and a C compiler. You can install
...
|   `rlpdump`   | Developer utility tool to convert binary RLP (Recursive Length Prefix) dumps (data encoding used by the UTG protocol both network as well as consensus wise) to user-friendlier hierarchical representation (e.g. `rlpdump --hex CE0183FFFFFFC4C304050583616263`).                                                                                                                                                                                                          |
...
this, `utg` has built-in support for a JSON-RPC based APIs (standard APIs
and `utg` specific APIs).
...
setup, please consult the utgerMining subreddit
and the utgminer repository.
...
* Commit messages should be prefixed with the package(s) they modify.
   * E.g. "utg, rpc: make trace configs optional"
